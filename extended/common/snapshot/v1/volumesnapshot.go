...
type VolumeSnapshotExpantionInterface interface {
	IsVolumeSnapshotReadyToUse(voulmeSnapshot *v1.VolumeSnapshot) (bool, error)
}
...
func (vs *VolumeSnapshotExpantion) IsVolumeSnapshotReadyToUse(voulmeSnapshot *v1.VolumeSnapshot) (bool, error) {
