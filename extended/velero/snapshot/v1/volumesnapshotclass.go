...
type velerovolumesnapshotclass struct {
	name                string
	volumesnapshotclass snapshotv1.VolumeSnapshotClassInterface
	annotations         map[string]string
	labels              map[string]string
}

func newDefaultVolumeSnapshotClass(volumesnapshotclass snapshotv1.VolumeSnapshotClassInterface) *velerovolumesnapshotclass {
...
func (vsc *velerovolumesnapshotclass) Create(name string, driver string, parameters map[string]string) (*v1.VolumeSnapshotClass, error) {
...
func (vsc *velerovolumesnapshotclass) CreateWithDefaultName(driver string, parameters map[string]string) (*v1.VolumeSnapshotClass, error) {
...
func (vsc *velerovolumesnapshotclass) List() (*v1.VolumeSnapshotClassList, error) {
