...
import (
	...
	"github.com/mperetzred/oadp-client-go/generated/velero/clientset/versioned/scheme"
...
// NewForConfigAndClient creates a new VeleroV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*VeleroV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
